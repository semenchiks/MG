...
export class SocketService {
    ...
    _getWebSocketUrl() {
        ...
        // Всегда используем единый endpoint /yjs на текущем хосте/порту
        // Это работает и локально (через node server.js с proxy Vite), и на Render
    ...
    async _initYjsConnection(roomName, isReset = false) {
        try {
            ...
            // Всегда используем WebsocketProvider на единой точке /yjs
